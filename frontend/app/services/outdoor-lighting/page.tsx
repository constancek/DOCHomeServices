...
export default function OutdoorLightingPage() {
  return (
    <>
      ...
      <section className="py-16">
        <MainWithSidebar>
          <div
            ...
            style={{ backgroundImage: 'url(/services/outdoor-lighting-hero.webp)' }}
            role="img"
      ...
      <section className="bg-hero-pink text-white">
        <div className="container-page grid items-center gap-8 py-14 lg:grid-cols-2 lg:py-16">
          <div
            ...
            style={{ backgroundImage: 'url(/services/outdoor-lighting-benefits.webp)' }}
            role="img"
      ...
      {/* Outdoor lighting by neighborhood — links DOWN to location pages */}
