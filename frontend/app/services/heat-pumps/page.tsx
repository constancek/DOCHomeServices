...
const faqs = [
  ...
  { q: 'What are SEER2 and HSPF2 ratings, and why do they matter?', a: 'SEER2 measures cooling efficiency and HSPF2 measures heating efficiency, and higher numbers mean less energy for the same work. The 2 matters: since 2023 equipment is tested under a tougher procedure, so a SEER2 number reads lower than the old SEER figure on a comparable unit. Compare like with like rather than a new quote against an old brochure.' },
    ...
    <>
      ...
      <section className="pb-16">
        <div className="container-page max-w-4xl">
          ...
          <NeighborhoodLinks copy={heatPumpsCopy} basePath="/services/heat-pumps" linkPrefix="Heat pumps" />
        </div>
      </section>
