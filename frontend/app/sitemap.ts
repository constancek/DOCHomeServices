...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes = ['', '/services', '/blog', '/areas', '/specials', '/free-estimate', '/comfort-club', '/heat-pump-incentives', '/about', '/careers', '/financing', '/customer-success-stories', '/reviews', '/referrals', '/university', '/faq'].map((path) => ({
    url: `${base}${path}/`,
